...
my $FILE         = $ARGV[0] // (getAutoDir() . "/AutoGlobalDefineEnum.h");
my $FILE_CPP     = $ARGV[1] // (getAutoDir() . "/AutoGlobalDefineEnumCpp.h");
my $FILE_CASE    = $ARGV[2] // (getAutoDir() . "/AutoGlobalDefineEnumCase.h");
