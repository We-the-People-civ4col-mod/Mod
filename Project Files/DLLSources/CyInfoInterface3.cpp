...
// KJ Jansson addon for Multiple Professions per Building modcomp by Androrc the Orc END
		...
		.def("getUnitClass", &CyYieldInfo::getUnitClass, "int ()")
	...
	python::class_<CyEventTriggerInfo, boost::noncopyable, python::bases<CvInfoBase> >("CvEventTriggerInfo")
		...
		.def("getNumUnits", &CyEventTriggerInfo::getNumUnits, "int ()")
		.def("getNumBuildings", &CvEventTriggerInfo::getNumBuildings, "int ()")
		.def("getNumUnitsGlobal", &CyEventTriggerInfo::getNumUnitsGlobal, "int ()")
		...
		.def("getUnitDamagedWeight", &CyEventTriggerInfo::getUnitDamagedWeight, "int ()")
		.def("getUnitDistanceWeight", &CyEventTriggerInfo::getUnitDistanceWeight, "int ()")
		.def("getUnitExperienceWeight", &CyEventTriggerInfo::getUnitExperienceWeight, "int ()")
		...
		.def("isUnitsOnPlot", &CyEventTriggerInfo::isUnitsOnPlot, "bool ()")
	...
	python::class_<CyEventInfo, boost::noncopyable, python::bases<CvInfoBase> >("CvEventInfo")
		...
		.def("getUnitClass", &CyEventInfo::getUnitClass, "int ()")
