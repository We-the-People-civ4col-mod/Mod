...
enum ColonialStatusTypes
{
	NO_COLONIAL_STATUS = -1,

	COLONIAL_STATUS_ANY,
	COLONIAL_STATUS_COLONIAL,
	COLONIAL_STATUS_IN_REVOLUTION,
	COLONIAL_STATUS_INDEPENDENT,

	NUM_COLONIAL_STATUS_TYPES,
	COMPILE_TIME_NUM_COLONIAL_STATUS_TYPES = NUM_COLONIAL_STATUS_TYPES,

	FIRST_COLONIAL_STATUS = 0,
};
...
enum PlayerActionTypes
{
	...
	PLAYER_ACTION_SET_DIPLO_YIELD_AMOUNT,
