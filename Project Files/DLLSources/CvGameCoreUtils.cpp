...
void getMissionAIString(CvWString& szString, MissionAITypes eMissionAI)
{
	...
	case MISSIONAI_NATIVE_TRADE: szString = L"MISSIONAI_NATIVE_TRADE"; break;
	case MISSIONAI_JOIN_GENERAL: szString = L"MISSIONAI_JOIN_GENERAL"; break;
	case MISSIONAI_JOIN_ADMIRAL: szString = L"MISSIONAI_JOIN_ADMIRAL"; break;
	case MISSIONAI_PIRACY_COUNTER: szString = L"MISSIONAI_PIRACY_COUNTER"; break;
