...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("AI_getTradeAttitude", &CyPlayer::AI_getTradeAttitude, "int (int /*PlayerTypes*/)")
		.def("AI_getTradeAttitudeValue", &CyPlayer::AI_getTradeAttitudeValue, "int (int /*PlayerTypes*/)")
		.def("AI_getTradeAttitudeGoldForNextLevel", &CyPlayer::AI_getTradeAttitudeGoldForNextLevel, "int (int /*PlayerTypes*/)")
		.def("AI_getTradeAttitudeTurnsUntilDecay", &CyPlayer::AI_getTradeAttitudeTurnsUntilDecay, "int (int /*PlayerTypes*/)")
		.def("AI_getTurnsUntilWillingToTalk", &CyPlayer::AI_getTurnsUntilWillingToTalk, "int (int /*PlayerTypes*/)")
		...
		.def("getYieldBoughtTotal", &CyPlayer::getYieldBoughtTotal, "int (TradeLocationTypes eLocation, int /*YieldTypes*/ eYield)")
		.def("grantEuropeUnit", &CyPlayer::grantEuropeUnit, python::return_value_policy<python::manage_new_object>(), "CyUnit (int /*UnitTypes*/ eUnit)")
