...
void CyInfoPythonInterface1()
{
	...
	python::class_<CyActionInfo, boost::noncopyable>("CvActionInfo")
		...
		.def("getAutomateType", &CyActionInfo::getAutomateType, "int ()")
		.def("getInterfaceModeType", &CyActionInfo::getInterfaceModeType, "int ()")
		.def("getMissionType", &CyActionInfo::getMissionType, "int ()")
		.def("getCommandType", &CyActionInfo::getCommandType, "int ()")
		.def("getControlType", &CyActionInfo::getControlType, "int ()")
