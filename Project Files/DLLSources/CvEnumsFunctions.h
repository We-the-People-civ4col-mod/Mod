...
SET_ENUM_VARIABLE_EXPANDED(SpecialBuildingTypes, getSpecialBuilding, JIT_ARRAY_BUILDING_SPECIAL, NUM_SPECIALBUILDING_TYPES, COMPILE_TIME_NUM_SPECIALBUILDING_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(CultureLevelTypes, getCulture, JIT_ARRAY_CULTURE, NUM_CULTURELEVEL_TYPES, COMPILE_TIME_NUM_CULTURELEVEL_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(EventTriggerTypes, getEventTrigger, JIT_ARRAY_EVENT_TRIGGER, NUM_EVENTTRIGGER_TYPES, COMPILE_TIME_NUM_EVENTTRIGGER_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(GameOptionTypes, getGameOption, JIT_ARRAY_GAME_OPTION, NUM_GAMEOPTION_TYPES, COMPILE_TIME_NUM_GAMEOPTION_TYPES)
SET_ENUM_VARIABLE_EXPANDED(GameSpeedTypes, getGameSpeed, JIT_ARRAY_GAME_SPEED, NUM_GAMESPEED_TYPES, COMPILE_TIME_NUM_GAMESPEED_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(PlayerColorTypes, getPlayerColor, JIT_ARRAY_PLAYER_COLOR, NUM_PLAYERCOLOR_TYPES, COMPILE_TIME_NUM_PLAYERCOLOR_TYPES)
SET_ENUM_VARIABLE_EXPANDED(PlayerOptionTypes, getPlayerOption, JIT_ARRAY_PLAYER_OPTION, NUM_PLAYEROPTION_TYPES, COMPILE_TIME_NUM_PLAYEROPTION_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(SeaLevelTypes, getSeaLevel, JIT_ARRAY_SEA_LEVEL, NUM_SEALEVEL_TYPES, COMPILE_TIME_NUM_SEALEVEL_TYPES)
...
SET_ENUM_VARIABLE_EXPANDED(SpecialUnitTypes, getSpecialUnit, JIT_ARRAY_UNIT_SPECIAL, NUM_SPECIALUNIT_TYPES, COMPILE_TIME_NUM_SPECIALUNIT_TYPES)
SET_ENUM_VARIABLE(Victory, VICTORY)
SET_ENUM_VARIABLE_EXPANDED(WorldSizeTypes, getWorldSize, JIT_ARRAY_WORLD_SIZE, NUM_WORLDSIZE_TYPES, COMPILE_TIME_NUM_WORLDSIZE_TYPES)
