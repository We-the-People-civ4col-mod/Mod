...
void CyPlotPythonInterface2(python::class_<CyPlot>& x)
{
	...
	x
		...
		.def("isNotCulture", &CyPlot::isNotCulture, "bool (int /*PlayerTypes*/ eIndex)")
		.def("canSetNotCulture", &CyPlot::canSetNotCulture, "bool (int /*PlayerTypes*/ eIndex)")
		.def("setNotCulture", &CyPlot::setNotCulture, "void (int /*PlayerTypes*/ eIndex, bool bNewValue)")
