...
void CyInfoPythonInterface2()
{
	...
	python::class_<CyCivilizationInfo, boost::noncopyable, python::bases<CvInfoBase> >("CvCivilizationInfo")
		.def("getDefaultPlayerColor", &CyCivilizationInfo::getDefaultPlayerColor, "int ()")
		.def("getArtStyleType", &CyCivilizationInfo::getArtStyleType, "int ()")
		//Androrc UnitArtStyles
		.def("getUnitArtStyleType", &CyCivilizationInfo::getUnitArtStyleType, "int ()")
		//Androrc End
		.def("getNumCityNames", &CyCivilizationInfo::getNumCityNames, "int ()")
		.def("getNumLeaders", &CyCivilizationInfo::getNumLeaders, "int ()")
		.def("getSelectionSoundScriptId", &CyCivilizationInfo::getSelectionSoundScriptId)
		.def("getActionSoundScriptId", &CyCivilizationInfo::getActionSoundScriptId)
		.def("getAdvancedStartPoints", &CyCivilizationInfo::getAdvancedStartPoints, "int ()")
		.def("getAreaMultiplier", &CyCivilizationInfo::getAreaMultiplier, "int ()")
		.def("getDensityMultiplier", &CyCivilizationInfo::getDensityMultiplier, "int ()")
		.def("getTreasure", &CyCivilizationInfo::getTreasure, "int ()")
		.def("getFavoredTerrain", &CyCivilizationInfo::getFavoredTerrain, "int ()")
		.def("getCapturedCityUnitClass", &CyCivilizationInfo::getCapturedCityUnitClass, "int ()")
		.def("getDefaultProfession", &CyCivilizationInfo::getDefaultProfession, "int ()")
		.def("getMissionaryChar", &CyCivilizationInfo::getMissionaryChar, "int ()")
		.def("getTradingPostChar", &CyCivilizationInfo::getTradingPostChar, "int ()")
		.def("isAIPlayable", &CyCivilizationInfo::isAIPlayable, "bool ()")
		.def("isPlayable", &CyCivilizationInfo::isPlayable, "bool ()")
		.def("isWaterStart", &CyCivilizationInfo::isWaterStart, "bool ()")
		.def("isOpenBorders", &CyCivilizationInfo::isOpenBorders, "bool ()")
		.def("isWaterWorks", &CyCivilizationInfo::isWaterWorks, "bool ()")
		.def("isEurope", &CyCivilizationInfo::isEurope, "bool ()")
		.def("isNative", &CyCivilizationInfo::isNative, "bool ()")
		.def("getShortDescription", &CyCivilizationInfo::pyGetShortDescription, "wstring ()")
		.def("getShortDescriptionKey", &CyCivilizationInfo::pyGetShortDescriptionKey, "wstring ()")
		.def("getAdjective", &CyCivilizationInfo::pyGetAdjective, "wstring ()")
		.def("getFlagTexture", &CyCivilizationInfo::getFlagTexture, "string ()")
		.def("getArtDefineTag", &CyCivilizationInfo::getArtDefineTag, "string ()")
		.def("getButton", &CyCivilizationInfo::getButton, "string ()")
		.def("getDerivativeCiv", &CyCivilizationInfo::getDerivativeCiv, "int ()")
		// Arrays
		.def("getCivilizationBuildings", &CyCivilizationInfo::getCivilizationBuildings, "int (int i)")
		.def("getCivilizationUnits", &CyCivilizationInfo::getCivilizationUnits, "int (int i)")
		.def("getNumCivilizationFreeUnits", &CyCivilizationInfo::getNumCivilizationFreeUnits, "int ()")
		.def("getCivilizationFreeUnitsClass", &CyCivilizationInfo::getCivilizationFreeUnitsClass, "int (index)")
		.def("getCivilizationFreeUnitsProfession", &CyCivilizationInfo::getCivilizationFreeUnitsProfession, "int (index)")
		.def("getCivilizationInitialCivics", &CyCivilizationInfo::getCivilizationInitialCivics, "int (int i)")
		.def("getFreeYields", &CyCivilizationInfo::getFreeYields, "int (int i)")
		.def("getTeachUnitClassWeight", &CyCivilizationInfo::getTeachUnitClassWeight, "int (int i)")
		.def("isLeaders", &CyCivilizationInfo::isLeaders, "bool (int i)")
		.def("isCivilizationFreeBuildingClass", &CyCivilizationInfo::isCivilizationFreeBuildingClass, "bool (int i)")
		.def("isValidProfession", &CyCivilizationInfo::isValidProfession, "bool (int i)")
		.def("hasTrait", &CyCivilizationInfo::hasTrait, "bool (int i)")
		.def("getCityNames", &CyCivilizationInfo::getCityNames, "stringw (int i)")
		;
