...
void CyPlayerPythonInterface4(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("setDiploYieldAmount", &CyPlayer::setDiploYieldAmount, "void (int /*YieldTypes*/ eYield, int iAmount)")
		.def("clearDiploYieldAmounts", &CyPlayer::clearDiploYieldAmounts, "void ()")
