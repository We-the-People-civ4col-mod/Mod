...
// (adjacent). Base weights control rarity. Adjacent tiles outrank range-2
// tiles. Coastal and great-river villages may teach Fisherman from water
// alone. A tribe prefers specialties not yet taught by another of its
// villages, limited to candidates within one suitability tier of the best
// available unique option. On Huge+ maps, a globally missing profession is
// filled first if local suitability is good, or suitable with a matching bonus.
