...
// python_enum_check.pl NEXT STATE
	...
	python::enum_<DiploEventTypes>("DiploEventTypes")
		...
		.value("DIPLOEVENT_ACQUIRE_USED_SHIPS_COUNTER_RESET", DIPLOEVENT_ACQUIRE_USED_SHIPS_COUNTER_RESET)
		.value("DIPLOEVENT_ACQUIRE_FOREIGN_IMMIGRANTS_COUNTER_RESET", DIPLOEVENT_ACQUIRE_FOREIGN_IMMIGRANTS_COUNTER_RESET)
