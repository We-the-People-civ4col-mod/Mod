...
void CyEnumsPythonInterface()
{
	...
	python::enum_<FontSymbols>("FontSymbols")
		.value("DUMMY_TO_SHIFT_01", DUMMY_TO_SHIFT_01)
		.value("DUMMY_TO_SHIFT_02", DUMMY_TO_SHIFT_02)
		.value("DUMMY_TO_SHIFT_03", DUMMY_TO_SHIFT_03)
		.value("DUMMY_TO_SHIFT_04", DUMMY_TO_SHIFT_04)
		.value("DUMMY_TO_SHIFT_05", DUMMY_TO_SHIFT_05)
		.value("DUMMY_TO_SHIFT_06", DUMMY_TO_SHIFT_06)
		.value("DUMMY_TO_SHIFT_07", DUMMY_TO_SHIFT_07)
		.value("DUMMY_TO_SHIFT_08", DUMMY_TO_SHIFT_08)
		.value("DUMMY_TO_SHIFT_09", DUMMY_TO_SHIFT_09)
		.value("DUMMY_TO_SHIFT_10", DUMMY_TO_SHIFT_10)
		.value("DUMMY_TO_SHIFT_11", DUMMY_TO_SHIFT_11)
		.value("DUMMY_TO_SHIFT_12", DUMMY_TO_SHIFT_12)
		.value("DUMMY_TO_SHIFT_13", DUMMY_TO_SHIFT_13)
		.value("DUMMY_TO_SHIFT_14", DUMMY_TO_SHIFT_14)
		.value("DUMMY_TO_SHIFT_15", DUMMY_TO_SHIFT_15)
		.value("DUMMY_TO_SHIFT_16", DUMMY_TO_SHIFT_16)
		.value("DUMMY_TO_SHIFT_17", DUMMY_TO_SHIFT_17)
		.value("DUMMY_TO_SHIFT_18", DUMMY_TO_SHIFT_18)
		.value("DUMMY_TO_SHIFT_19", DUMMY_TO_SHIFT_19)
		.value("DUMMY_TO_SHIFT_20", DUMMY_TO_SHIFT_20)
		.value("DUMMY_TO_SHIFT_21", DUMMY_TO_SHIFT_21)
		.value("DUMMY_TO_SHIFT_22", DUMMY_TO_SHIFT_22)
		.value("DUMMY_TO_SHIFT_23", DUMMY_TO_SHIFT_23)
		.value("DUMMY_TO_SHIFT_24", DUMMY_TO_SHIFT_24)
		.value("DUMMY_TO_SHIFT_25", DUMMY_TO_SHIFT_25)
