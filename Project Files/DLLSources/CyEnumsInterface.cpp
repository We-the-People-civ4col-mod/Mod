...
// python_enum_check.pl NEXT STATE
	...
	python::enum_<MissionAITypes>("MissionAITypes")
		...
		.value("MISSIONAI_JOIN_CITY", MISSIONAI_JOIN_CITY)
		.value("MISSIONAI_NATIVE_TRADE", MISSIONAI_NATIVE_TRADE)
		.value("MISSIONAI_JOIN_GENERAL", MISSIONAI_JOIN_GENERAL)
		.value("MISSIONAI_JOIN_ADMIRAL", MISSIONAI_JOIN_ADMIRAL)
		.value("MISSIONAI_PIRACY_COUNTER", MISSIONAI_PIRACY_COUNTER)
		.value("MISSIONAI_GUARD_COAST", MISSIONAI_GUARD_COAST)
		.value("MISSIONAI_REINFORCE", MISSIONAI_REINFORCE)
		.value("MISSIONAI_CHOKE", MISSIONAI_CHOKE)
		.value("MISSIONAI_HEAL", MISSIONAI_HEAL)
		.value("MISSIONAI_RETREAT", MISSIONAI_RETREAT)
		.value("MISSIONAI_PATROL", MISSIONAI_PATROL)
		.value("MISSIONAI_DEFEND", MISSIONAI_DEFEND)
		.value("MISSIONAI_COUNTER_ATTACK", MISSIONAI_COUNTER_ATTACK)
		.value("MISSIONAI_UPGRADE", MISSIONAI_UPGRADE)
		.value("MISSIONAI_STRANDED", MISSIONAI_STRANDED)
