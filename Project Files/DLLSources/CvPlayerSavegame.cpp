...
const int defaultOppressometerDiscriminationModifier = GC.getDefineINT("OPPRESSOMETER_DISCRIMINATION_MODIFIER_BASE_COLONIZERS");
const int defaultOppressometerForcedLaborModifier = GC.getDefineINT("OPPRESSOMETER_FORCED_LABOR_MODIFIER_BASE");
