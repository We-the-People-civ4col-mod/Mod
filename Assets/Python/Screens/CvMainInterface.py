...
BUILDING_DATA[2] = [68, 20, 20, 12] #Meat
BUILDING_DATA[3] = [36, 38, 20, 12] #Coats
BUILDING_DATA[4] = [52, 40, 20, 12] #Leather
BUILDING_DATA[5] = [4, 20, 20, 12] #Cloth
BUILDING_DATA[6] = [68, 38, 20, 12] #Coloured Cloth
BUILDING_DATA[7] = [20, 40, 20, 12] #Beer
BUILDING_DATA[8] = [68, 2, 20, 12] #Rum
BUILDING_DATA[9] = [68, 56, 20, 12] #Wine
BUILDING_DATA[10] = [20, 22, 20, 12] #Cigars
BUILDING_DATA[11] = [84, 4, 20, 12] #Whale oil
BUILDING_DATA[12] = [36, 56, 20, 12] #Furniture
BUILDING_DATA[13] = [52, 4, 20, 12] #Tools
BUILDING_DATA[14] = [36, 2, 20, 12] #Crosses
BUILDING_DATA[15] = [4, 38, 20, 12] #Muskets
BUILDING_DATA[16] = [20, 58, 20, 12] #Horses
BUILDING_DATA[17] = [84, 22, 20, 12] #Dock
BUILDING_DATA[18] = [4, 2, 20, 12] #WareHouse
BUILDING_DATA[19] = [4, 56, 20, 12] #Spices
BUILDING_DATA[20] = [52, 58, 20, 12] #Domestic Market
BUILDING_DATA[21] = [80, 70, 20, 10] #Tavern
BUILDING_DATA[22] = [20, 4, 20, 12] #Education
BUILDING_DATA[23] = [90, 82, 20, 10] #Wall
BUILDING_DATA[24] = [90, 75, 20, 9] #Print
BUILDING_DATA[25] = [90, 66, 20, 10] #Mill
BUILDING_DATA[26] = [80, 60, 20, 10] #Trainstation
BUILDING_DATA[27] = [90, 58, 20, 8] #Corn
BUILDING_DATA[28] = [84, 40, 20, 13] #Medical Care
BUILDING_DATA[29] = [80, 88, 20, 8] #Well
BUILDING_DATA[30] = [80, 80, 20, 10] #Defense
BUILDING_DATA[31] = [80, 80, 20, 12] #Confectioner
BUILDING_DATA[32] = [80, 80, 20, 12] #Leather Padder
BUILDING_DATA[33] = [80, 80, 20, 12] #Cooking Oil Trader
BUILDING_DATA[34] = [80, 80, 20, 12] #Peanut Roaster
BUILDING_DATA[35] = [80, 80, 20, 12] #Potter
BUILDING_DATA[36] = [80, 80, 20, 12] #Tailor
BUILDING_DATA[37] = [80, 80, 20, 12] #Statue
...
#<--- TAC
			...
			# CITY HAMMER PRODUCTION
				...
				screen.setLabel("HammerText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, xResolution * 12 / 100 +iXmodifier , CITY_TITLE_BAR_HEIGHT / 12, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_PRODUCTION_MOD_HELP, -1, -1 )
			...
			# CITY LIBERTYBELL PRODUCTION
				...
				screen.setLabel("LibertyText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, xResolution * 16 / 100 +iXmodifier, CITY_TITLE_BAR_HEIGHT / 12, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_HELP_YIELD, YieldTypes.YIELD_BELLS, -1 )
			...
			# CITY CROSS PRODUCTION
				...
				screen.setLabel("CrossesText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, xResolution * 20 / 100 +iXmodifier, CITY_TITLE_BAR_HEIGHT / 12, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_HELP_YIELD, YieldTypes.YIELD_CROSSES, -1 )
			...
			# CITY EDUCATION PRODUCTION
				...
				screen.setLabel("EducationText", "Background", szBuffer, CvUtil.FONT_CENTER_JUSTIFY, xResolution * 24 / 100 +iXmodifier, CITY_TITLE_BAR_HEIGHT / 12, -0.3, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_HELP_YIELD, YieldTypes.YIELD_EDUCATION, -1 )
