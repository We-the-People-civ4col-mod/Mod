...
IconMap = {
			...
			"[ICON_OCCUPATION_CUSTOM]": FontSymbols.OCCUPATION_CHAR_CUSTOM,
			"[ICON_DEFENSE_CUSTOM]": FontSymbols.DEFENSE_CHAR_CUSTOM,
			"[ICON_POWER_CUSTOM]": FontSymbols.POWER_CHAR_CUSTOM,
